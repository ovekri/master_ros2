...
void VelodyneScan__rosidl_typesupport_introspection_c__VelodyneScan_init_function(
...
void VelodyneScan__rosidl_typesupport_introspection_c__VelodyneScan_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers VelodyneScan__rosidl_typesupport_introspection_c__VelodyneScan_message_members = {
  ...
  VelodyneScan__rosidl_typesupport_introspection_c__VelodyneScan_init_function,  // function to initialize message memory (memory has to be allocated)
  VelodyneScan__rosidl_typesupport_introspection_c__VelodyneScan_fini_function  // function to terminate message instance (will not free memory)
};
