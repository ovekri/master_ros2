...
class LiDAR_broadcast(Node):                                                                                                                        # new class that inherits from Node class
    ...
    def transform(self):
        ...
        t.header.frame_id = 'original_lidar_frame'                                                                                                  # Set the parent frame ID to represent the car
        t.child_frame_id = 'transformed_lidar_frame'                                                                                                # Set the child frame ID to represent the lidar
        
        t.transform.translation.x = 0.0
        t.transform.translation.y = 0.0
        t.transform.translation.z = 0.0
        q = quaternion_from_euler(0, 0, -45 * 3.141592 / 180)                                                                                       # rotate -45 degrees on the z-axis
